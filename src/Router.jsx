  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={<ProtectedRoute element={<AvailableTrains />} />}
      />
      <Route
        path="/available-buses"
        element={<ProtectedRoute element={<AvailableBuses />} />}
      />
      <Route
        path="/available-flights"
        element={<ProtectedRoute element={<AvailableFlights />} />}
      />
      <Route
        path="/payment"
      ...
      <Route
        path="/payment-bus"
        element={<ProtectedRoute element={<PaymentPageBus />} />}
      />
      <Route
        path="/payment-flight"
        element={<ProtectedRoute element={<PaymentPageFlight />} />}
      />
